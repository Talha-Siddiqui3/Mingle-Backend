...
CREATE TABLE `Hobbies` (
  ...
  KEY `hobbyListName_idx` (`hobbyName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Members` (
  ...
  CONSTRAINT `idProfileMember` FOREIGN KEY (`idProfile`) REFERENCES `Profiles` (`idProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Messages` (
  ...
  CONSTRAINT `idProfileMessage` FOREIGN KEY (`idProfile`) REFERENCES `Profiles` (`idProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Pictures` (
  ...
  CONSTRAINT `idProfilePictures` FOREIGN KEY (`idProfile`) REFERENCES `Profiles` (`idProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Profiles` (
  `idProfile` int NOT NULL,
  `name` varchar(45) DEFAULT NULL,
  `pictureProfile` varchar(200) DEFAULT NULL,
...
CREATE TABLE `UserHobbies` (
  ...
  PRIMARY KEY (`idProfile`,`idHobby`),
  KEY `idHobby_idx` (`idHobby`),
  CONSTRAINT `idHobby` FOREIGN KEY (`idHobby`) REFERENCES `Hobbies` (`idHobbies`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `UserHobbies` WRITE;
/*!40000 ALTER TABLE `UserHobbies` DISABLE KEYS */;
/*!40000 ALTER TABLE `UserHobbies` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Users` (
  ...
  CONSTRAINT `idProfileUser` FOREIGN KEY (`idProfile`) REFERENCES `Profiles` (`idProfile`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-20  1:38:47
